...
angular.module('desktopApp')
    ...
    var totalBloomTime = 60;
    var totalPourTime = 165;

		vm.bloomCounter = totalBloomTime;
		vm.pourCounter = totalPourTime;
    ...
    var pouring = 0;
        ...
        // Calculate the percentage finsihed.
        blooming += 1;
        var percentBloom = ((blooming / totalBloomTime) * 100);
        vm.percentBloom = percentBloom;
        ...
        pouring += 1;
        var percentBloom = ((pouring / totalPourTime) * 100);
        vm.percentPour = percentBloom;
